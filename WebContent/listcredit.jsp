...
<%@ page import="com.iao.model.CreditModel" %>   <!DOCTYPE html>
<html>
<head>
...
<form method="post" action="FetchSerlvlet">
 ...
 <div id="wrapper">
  ...
  <h1>Liste Des Credits Effectue Par Le Client <b> " ${username }"</b></h1>
  ...
  <center><button class="wrap btn" style="background-color:#ff7069;">  <a  href="index.jsp" style="color:white;">home</a>   </button></center>
